    ...
    <div data-testid="channel-inspector" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '12px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div>
          ...
          {emitters.map(e => (
            <div key={e.role} style={{ fontSize: '13px', padding: '2px 0', color: 'var(--color-text-secondary)' }}>
...
const inputStyle: React.CSSProperties = { width: '100%', padding: '6px 8px', fontSize: '13px', border: '1px solid var(--color-border)', borderRadius: '4px', background: 'var(--color-bg)', color: 'var(--color-text)', boxSizing: 'border-box' as const };
